...
<div class="flex flex-col pt-4 w-full px-8 items-center gap-2">
	<div>
		<h1 class="text-4xl font-bold w-full text-center text-blue-600">Healthcare AI Chat</h1>
	</div>
	<div class="h-screen w-full bg-gray-900 rounded-md p-4 overflow-y-auto flex flex-col gap-4">
